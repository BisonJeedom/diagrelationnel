...
$plugin = plugin::byId('diagrelationnel');
...
<div class="row row-overflow">
	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<legend><i class="fas fa-table"></i> {{Mes diagrammes}}</legend>
		<?php
		if (count($eqLogics) == 0) {
			echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun diagramme trouvé, cliquer sur "Ajouter"}}</div>';
		} else {
			// Champ de recherche
...
<?php include_file('desktop', 'diagrelationnel', 'js', 'diagrelationnel'); ?>
